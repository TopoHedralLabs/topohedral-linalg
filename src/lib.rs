...
pub use expression::unary_expr::{
    ...
    algebraic_sub, asin, asinh, atan, atan2, atanh, cbrt, ceil, clamp, clamp_magnitude,
    copysign, cos, cosh, div_euclid, erf, erfc, exp, exp2, exp_m1, floor, fract, gamma, hypot,
    ln, ln_1p, log, log10, log2, max, maximum, midpoint, min, minimum, mul_add, next_down,
    next_up, powf, powi, recip, rem_euclid, round, round_ties_even, signum, sin, sinh, sqrt,
